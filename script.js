    ...
    video.onplay = function () {
        ...
        (function loop() {
            if (!vid.paused && !vid.ended) {
                ...
                context1.drawImage(vid, 0, 0, vid.videoWidth, vid.videoHeight);
                //Get image data from context1 and detect edge
                let frame = context1.getImageData(0, 0, vid.videoWidth, vid.videoHeight);

                var frameEdge = sobel(frame, threshold);
